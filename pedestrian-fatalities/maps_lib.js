...
var MapsLib = {
  ...
  fusionTableId:      "1fZOWBEev1pqg96_3hsmomxtlish5sNMJTPydz8Q",

  //*New Fusion Tables Requirement* API key. found at https://code.google.com/apis/console/
  //*Important* this key is for demonstration purposes. please register your own.
  googleApiKey:       "AIzaSyDTp6-HB2ymILc3Rzk3BN_MIQxc2A5W5rI",

  //name of the location column in your Fusion Table.
  //NOTE: if your location column name has spaces in it, surround it with single quotes
  //example: locationColumn:     "'my location'",
  locationColumn:     "LAT_LONG",

  map_centroid:       new google.maps.LatLng(37.5958, -122.0797), //center that your map defaults to
  ...
  initialize: function() {
    ...
    //-----custom initializers-------
      ...
      //starting values
      var startDate = moment("Jan 1 2007"); //past 3 months
      var endDate = moment("Dec 31 2011"); //now
...
sliderInterval: function(interval) {
  ...
  doSearch: function(location) {
    ...
    //-----custom filters-------
var type_column = "'crosswalk_code'";
  ...
  submitSearch: function(whereClause, map, location) {
    ...
    MapsLib.searchrecords = new google.maps.FusionTablesLayer({
      ...
      styles: [
        {
          where: "crosswalk_code = 1",
          markerOptions: {
            iconName: "small_red"
          }
        },{
          where: 'crosswalk_code = 2',
          markerOptions: {
            iconName: "small_yellow"
          }
        },{
        where: 'crosswalk_code = 3',
          markerOptions: {
            iconName: "small_blue"
          }
        },{
          where: 'crosswalk_code = 4',
          markerOptions: {
